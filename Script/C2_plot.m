...
for i = 1:9 
    ...
    if type_lesion == "unisx" || type_lesion == "unidx" % unilaterale
        ...
        % plot
        ploteuclidean(top,bot,prn,'r')
        ploteuclidean(sx,dx,prn,'k')
        ...
        % plot
        ploteuclidean(top_right,bot_right,prn,'r')
        ploteuclidean(sx_right,dx_right,prn,'k')
        ploteuclidean(top_left,bot_left,prn,'r')
        ploteuclidean(sx_left,dx_left,prn,'k')
